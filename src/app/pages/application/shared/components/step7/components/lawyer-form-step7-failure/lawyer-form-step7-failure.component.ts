...
@Component({
  selector: 'app-lawyer-form-step7-failure',
  templateUrl: './lawyer-form-step7-failure.component.html',
  styleUrls: ['./lawyer-form-step7-failure.component.scss'],
})
export class LawyerFormStep7FailureComponent implements OnInit {
  form!: FormGroup;
  ...
  ngOnInit(): void {
    this.form = new FormGroup({
      ...
      appeals: new FormControl(null, Validators.required),
    });
  }
