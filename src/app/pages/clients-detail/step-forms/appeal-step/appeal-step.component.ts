...
export class AppealStepComponent implements OnInit, OnDestroy {
  @Input() step!: any;
  ...
  ngOnInit(): void {
    this.stepForm = new FormGroup({
      ...
      in_doc_number: new FormControl(''),
      in_doc_date: new FormControl(''),
  ...
  getCourtPlace(type: any, place: any): any {
    return this.courtsType?.find((el: any) => el.key === type)
