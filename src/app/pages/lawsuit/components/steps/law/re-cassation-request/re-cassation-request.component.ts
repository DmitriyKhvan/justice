...
@Component({
  selector: 'app-re-cassation-request',
  templateUrl: './re-cassation-request.component.html',
  styleUrls: ['./re-cassation-request.component.scss'],
})
export class ReCassationRequestComponent implements OnInit, OnDestroy {
  ...
  submit(actionId: number) {
    ...
    this.lawsuitService
      .apiFetch(data, 'law/add/reCassationRequest', actionId)
      .subscribe(
        (actions) => {
