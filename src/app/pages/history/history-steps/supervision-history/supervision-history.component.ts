...
@Component({
  selector: 'app-supervision-history',
  template: `
    <details
    ...
    >
      ...
      <div class="content m-0 py-1 pr-2">
        <div class="row flex-nowrap align-items-end mb-1">
          ...
          <div class="col-6">
            <div class="form-field__title mb-1">
              Дата внесение в суд или прокуратуру
            </div>
            <div class="form-field__disabled">
              {{ history?.entry_date }}
            </div>
        ...
        <div class="form-field__title mb-1">Скан документа</div>
        <div class="mb-2">
          <div
...
export class SupervisionHistoryComponent implements OnInit, OnDestroy {
  @Input() step!: any;
