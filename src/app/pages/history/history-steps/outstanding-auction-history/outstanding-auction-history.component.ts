...
@Component({
  selector: 'app-outstanding-auction-history',
  template: `
    <details
        ...
        >
          ...
          >
            <div
              ...
              [class.custom-toggle-thumb_active]="history?.auction"
            ></div>
          </div>
          <div class="form-field__title m-0">Аукцион</div>
        </div>

        <div class="row flex-nowrap mb-2" *ngIf="history?.auction">
          <div class="col-6">
...
export class OutstandingAuctionHistoryComponent implements OnInit, OnDestroy {
  @Input() step!: any;
